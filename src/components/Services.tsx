    ...
    <section className="bg-gray-100 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-white to-gray-50 rounded-lg p-6 border border-gray-200 shadow-sm mb-8">
          <h3 className="text-xl font-semibold mb-4" style={{ color: '#787346' }}>Missions incluses (7,6% du montant des travaux)</h3>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="bg-gray-100/50">
                  ...
                  <td className="px-4 py-4 text-right text-gray-900 font-mono font-bold">21 061,50 €</td>
                  <td className="px-4 py-4 text-right text-gray-600 font-mono">4 212,30 €</td>
                  <td className="px-4 py-4 text-right font-mono font-bold" style={{ color: '#c1a16a' }}>25 273,80 €</td>
                </tr>
              </tbody>
            </table>
          </div>
