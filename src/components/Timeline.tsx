...
const Timeline: React.FC = () => {
  const phases = [
    ...
    { name: "Travaux de construction", duration: "9-10 mois", start: "Selon planning détaillé" },
  ];
  ...
  const clarifications = [
    {
      ...
      items: [
        "Validation de l'emprise au sol autorisée selon le PLU de Gémenos",
        "Vérification des prescriptions architecturales locales",
        "Nécessité d'un bassin de rétention des eaux pluviales"
      ]
    },
    {
      title: "Viabilisation du terrain",
      items: [
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-t-2" style={{ background: 'linear-gradient(to right, rgba(193, 161, 106, 0.2), rgba(193, 161, 106, 0.1))', borderTopColor: '#c1a16a' }}>
                    ...
                    <td className="px-4 py-4 text-center font-mono font-bold text-lg" style={{ color: '#c1a16a' }}>14-18 mois</td>
